    ...
    public class SuppliersController : ApiController
    {
        ...
        public IHttpActionResult GetSuppliers()
        {
            ...
            result.Columns = new EnterpriseService.DataTableColumn[] {
                ...
                new EnterpriseService.DataTableColumn { name = "HomePage", @class = "java.lang.String" }
            };
            ...
            //データを取得し、格納
            var data = db.Suppliers.AsEnumerable<Supplier>();
            foreach (var d in data)
            {
                EnterpriseService.DataTableRowsRowCell[] cells = {
                    new EnterpriseService.DataTableRowsRowCell { index = "0", Value = d.SupplierID.ToString() },
                    ...
                    new EnterpriseService.DataTableRowsRowCell { index = "11", Value = d.HomePage }
                    };
